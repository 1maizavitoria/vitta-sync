...
public class SinaisVitaisService {
    ...
    public void delete(Integer id, Integer usuarioLogadoId) {
        ...
        SinaisVitais sinais = repository.findById(id)
                .orElseThrow(() -> new RecursoNaoEncontradoException("Sinais vitais não encontrados"));
    ...
    public List<SinaisVitais> findByPacienteId(Integer pacienteId) {
        return repository.findByPacienteId(pacienteId);
    }

    public List<Integer> findTodosPacientesIds() {
        return repository.findTodosPacientesIds();
    }
}
