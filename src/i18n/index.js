    ...
    "pt-BR": {
        ...
        reports: {
            ...
            export: {
                ...
                invalidDates: "Informe datas válidas, com a data inicial anterior ou igual à final.",
                include: "O que incluir", categories: { SINAIS: "Sinais vitais", SINTOMAS: "Sintomas", HABITOS: "Hábitos" },
                chooseCategory: "Selecione ao menos uma categoria.", format: "Formato",
                pdfHint: "Resumo com tabelas e gráficos. Documento em português.", csvHint: "Registros individuais para abrir em uma planilha.",
                preview: "Visualizar prévia", loadingPreview: "Carregando prévia…", download: "Baixar relatório", generating: "Gerando arquivo…",
                previewTitle: "Prévia dos dados", issuedAt: "Gerado em",
                previewHint: "Confira os dados nas unidades do relatório. O PDF terá sua própria diagramação; o CSV contém os registros individuais.",
                indicator: "Indicador", mean: "Média", min: "Mínimo", max: "Máximo", count: "Medições",
                evolution: "Evolução", dailyMeans: "Médias diárias; intervalos sem registro interrompem a linha",
                metrics: { fcBpm: "Frequência cardíaca", frRpm: "Frequência respiratória", paSistolica: "Pressão sistólica", paDiastolica: "Pressão diastólica", tempCelcius: "Temperatura", spo2Porcento: "Saturação" },
                occurrence: "Ocorrência", symptom: "Sintoma", pain: "Dor (1–10)",
                sleep: "Sono médio", exercise: "Atividade física total", recordedDays: "Dias com registro",
                habitsHint: "Sono: média das médias diárias. Atividade física: soma dos minutos registrados.",
                missingHint: "Valores ausentes aparecem como — e não entram nos cálculos como zero.",
                empty: "Nenhum registro encontrado para os filtros selecionados.", emptyCategory: "Sem registros desta categoria no período.",
                selectPatient: "Selecione um paciente para exportar o relatório.", downloadStarted: "Download iniciado.",
                forbidden: "Você não tem permissão para acessar os dados deste paciente.", patientMissing: "Paciente não encontrado. Atualize a seleção.",
                invalidFilters: "Confira o período, as categorias e o formato selecionados.", requestError: "Não foi possível gerar o relatório. Tente novamente.",
            },
            ...
            emergencyContacts: {
                ...
                selectChannel: "Selecione pelo menos um canal de comunicação",
                email: "E-mail",
                channels: "Canais de comunicação",
                channelsDescription: "Escolha como este contato receberá os alertas.",
                emailChannel: "E-mail",
                smsChannel: "SMS",
                alertPreferences: "Preferências de alerta",
                vitalSigns: "Sinais vitais",
                habits: "Hábitos",
                generalStability: "Estabilidade geral",
                healthy: "Saudável",
                moderate: "Moderado",
                critical: "Crítico",
    ...
    en: {
        ...
        reports: {
            ...
            export: {
                ...
                invalidDates: "Enter valid dates, with the start date on or before the end date.",
                include: "Include", categories: { SINAIS: "Vital signs", SINTOMAS: "Symptoms", HABITOS: "Habits" },
                chooseCategory: "Select at least one category.", format: "Format",
                pdfHint: "Summary with tables and charts. Document in Portuguese.", csvHint: "Individual records for a spreadsheet.",
                preview: "Preview", loadingPreview: "Loading preview…", download: "Download report", generating: "Generating file…",
                previewTitle: "Data preview", issuedAt: "Generated at",
                previewHint: "Review data in the report's units. The PDF has its own layout; the CSV contains individual records.",
                indicator: "Indicator", mean: "Mean", min: "Minimum", max: "Maximum", count: "Measurements",
                evolution: "Trend", dailyMeans: "Daily means; gaps in records interrupt the line",
                metrics: { fcBpm: "Heart rate", frRpm: "Respiratory rate", paSistolica: "Systolic pressure", paDiastolica: "Diastolic pressure", tempCelcius: "Temperature", spo2Porcento: "Oxygen saturation" },
                occurrence: "Occurrence", symptom: "Symptom", pain: "Pain (1–10)",
                sleep: "Mean sleep", exercise: "Total physical activity", recordedDays: "Days recorded",
                habitsHint: "Sleep: mean of daily means. Physical activity: sum of recorded minutes.",
                missingHint: "Missing values appear as — and are not counted as zero in calculations.",
                empty: "No records found for the selected filters.", emptyCategory: "No records in this category for the period.",
                selectPatient: "Select a patient to export the report.", downloadStarted: "Download started.",
                forbidden: "You do not have permission to access this patient's data.", patientMissing: "Patient not found. Update your selection.",
                invalidFilters: "Check the selected period, categories and format.", requestError: "Unable to generate the report. Please try again.",
            },
            ...
            emergencyContacts: {
                ...
                selectChannel: "Select at least one communication channel",
                email: "Email",
                channels: "Communication channels",
                channelsDescription: "Choose how this contact will receive alerts.",
                emailChannel: "Email",
                smsChannel: "SMS",
                alertPreferences: "Alert preferences",
                vitalSigns: "Vital signs",
                habits: "Habits",
                generalStability: "General stability",
                healthy: "Healthy",
                moderate: "Moderate",
                critical: "Critical",
    ...
    es: {
        ...
        reports: {
            ...
            export: {
                ...
                invalidDates: "Introduce fechas válidas, con la fecha inicial anterior o igual a la final.",
                include: "Qué incluir", categories: { SINAIS: "Signos vitales", SINTOMAS: "Síntomas", HABITOS: "Hábitos" },
                chooseCategory: "Selecciona al menos una categoría.", format: "Formato",
                pdfHint: "Resumen con tablas y gráficos. Documento en portugués.", csvHint: "Registros individuales para una hoja de cálculo.",
                preview: "Ver vista previa", loadingPreview: "Cargando vista previa…", download: "Descargar informe", generating: "Generando archivo…",
                previewTitle: "Vista previa de los datos", issuedAt: "Generado el",
                previewHint: "Revisa los datos en las unidades del informe. El PDF tiene su propio diseño; el CSV contiene los registros individuales.",
                indicator: "Indicador", mean: "Media", min: "Mínimo", max: "Máximo", count: "Mediciones",
                evolution: "Evolución", dailyMeans: "Medias diarias; los intervalos sin registros interrumpen la línea",
                metrics: { fcBpm: "Frecuencia cardíaca", frRpm: "Frecuencia respiratoria", paSistolica: "Presión sistólica", paDiastolica: "Presión diastólica", tempCelcius: "Temperatura", spo2Porcento: "Saturación" },
                occurrence: "Ocurrencia", symptom: "Síntoma", pain: "Dolor (1–10)",
                sleep: "Sueño medio", exercise: "Actividad física total", recordedDays: "Días con registros",
                habitsHint: "Sueño: media de las medias diarias. Actividad física: suma de los minutos registrados.",
                missingHint: "Los valores ausentes aparecen como — y no cuentan como cero en los cálculos.",
                empty: "No se encontraron registros para los filtros seleccionados.", emptyCategory: "Sin registros de esta categoría en el período.",
                selectPatient: "Selecciona un paciente para exportar el informe.", downloadStarted: "Descarga iniciada.",
                forbidden: "No tienes permiso para acceder a los datos de este paciente.", patientMissing: "Paciente no encontrado. Actualiza la selección.",
                invalidFilters: "Revisa el período, las categorías y el formato seleccionados.", requestError: "No se pudo generar el informe. Inténtalo de nuevo.",
            },
            ...
            emergencyContacts: {
                ...
                invalidEmail: "Email inválido",
                selectChannel: "Selecciona al menos un canal de comunicación",
                email: "Email",
                channels: "Canales de comunicación",
                channelsDescription: "Elige cómo este contacto recibirá las alertas.",
                emailChannel: "Email",
                smsChannel: "SMS",
                alertPreferences: "Preferencias de alerta",
                vitalSigns: "Signos vitales",
                habits: "Hábitos",
                generalStability: "Estabilidad general",
                healthy: "Saludable",
                moderate: "Moderado",
                critical: "Crítico",
